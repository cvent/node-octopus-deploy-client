...
describe('Dashboard Api', function(){
  ...
  it('should be able to get a dashboard', function(done){
  ...
  it('should be able to get the dynamic dashboard', function(done){
    mock.get('/api/dashboard/dynamic')
      .reply(200, {
        Projects: [],
        ProjectGroups: [],
        Environments: [],
    ...
    client.resources.dashboard.dynamic.get()
      .then(helper.successResponse)
      .then(function(resp){
        should(resp.body.Items[0].Id).eql('deployments-1');
        done();
